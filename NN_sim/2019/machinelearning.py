...
hid_size = 400
layer_num = 2
network = TwoLayerNet(input_size = x_train.shape[1], hidden_size = hid_size, output_size = t_train.shape[1])
iters_num = 100000
...
y_val = test_loss
plt.plot(x, y_val, label = "Test", color = "#ff4500")
plt.legend()
plt.xlabel('Iter number')
#plt.xlabel('Epoch')
plt.ylabel('Loss')
...
y_w1 = w1_value
plt.plot(x, y_w1, label = "W1", color = "#008000")
plt.legend()
plt.xlabel('Iter number')
#plt.xlabel('Epoch')
...
y_b1 = b1_value
plt.plot(x, y_b1, label = "b1", color = "#008000")
plt.legend()
plt.xlabel('Iter number')
#plt.xlabel('Epoch')
...
y_w2 = w2_value
plt.plot(x, y_w2, label = "W2", color = "#483d8b")
plt.legend()
plt.xlabel('Iter number')
#plt.xlabel('Epoch')
...
y_b2 = b2_value
plt.plot(x, y_b2, label = "b2", color = "#483d8b")
plt.legend()
plt.xlabel('Iter number')
#plt.xlabel('Epoch')
